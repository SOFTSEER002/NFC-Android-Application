...
public class WriteActivity extends Activity {
    ...
    private String encrypttag = null;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            if(extras == null) {
                ...
                encrypttag= extras.getString("nfc_tag");
            }
        } else {
            encrypttag= (String) savedInstanceState.getSerializable("nfc_tag");
        }
        initViews();
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (tag != null) {
            if (isWrite) {
                String messageToWrite = encrypttag;
                ...
                if (messageToWrite != null && (!TextUtils.equals(messageToWrite, "null")) && (!TextUtils.isEmpty(messageToWrite))) {
                    ...
                    Toast.makeText(this,"Writeable Encrypted Data Not Found",Toast.LENGTH_LONG).show();
                }
            }
        }
    }
